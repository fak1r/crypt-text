  ...
  <q-layout class="q-pa-md" view="lHr lpR fFf">
    <q-header reveal elevated class="bg-primary text-white">
      <q-toolbar>
        ...
        <q-toolbar-title> CrypText </q-toolbar-title>

        <q-fab direction="down" padding="10px" unelevated class="lang-icon" flip-horizontal>
    ...
    <q-drawer v-model="leftDrawerOpen" side="left" elevated class="left-menu">
      <q-list>
        <q-item-label header>
    ...
    <q-drawer v-model="rightDrawerOpen" side="right" elevated class="right-menu" :width="200">
      <q-item-label header>
        {{ store.lang.menuKey }}
      </q-item-label>
