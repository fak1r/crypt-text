    ...
    <div class="child-container">
      ...
      <transition appear enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
        <div class="q-mb-md auth-alert" v-if="!authStore.user.email && showAuthWarning">
          ...
          <q-icon @click="showAuthWarning = false" class="close-icon" name="close" size="24px" />
        </div>
      </transition>
              ...
              >
                <template #buttons>
                  <div class="q-pb-md q-pr-md">
                    <q-btn @click="cryptText" class="btn" :disabled="!textToCrypt" no-caps
                      >{{ store.lang.btnCrypt }}
                    </q-btn>
                  </div>
                  <div class="q-pr-md q-pb-md">
                    <q-btn class="btn" :disabled="!cryptedText" @click="showCryptResult = true" no-caps
          ...
          <transition appear enter-active-class="animated pulse">
            <div class="decrypt">
              ...
              >
                <template #buttons>
                  <div class="q-pr-md q-pb-md">
                    <q-btn @click="decryptText" class="btn" :disabled="!textToDecrypt" no-caps
                      >{{ store.lang.btnDecrypt }}
                    </q-btn>
                  </div>
                  <div class="q-pr-md q-pb-md">
                    <q-btn class="btn" :disabled="!decryptedText" @click="showDecryptResult = true" no-caps
                      >{{ store.lang.btnShowResult }}
                    </q-btn>
                  </div>
                </template>
